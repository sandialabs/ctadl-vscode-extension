...
public final class q0 {
    ...
    public static final Method f209a;
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f209a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f209a) != null) {
            try {

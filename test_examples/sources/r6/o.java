...
public final class o implements Callable<List<t6.d>> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ y3.m f17106a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ s f17107b;

    public o(s sVar, y3.m mVar) {
        this.f17107b = sVar;
        this.f17106a = mVar;
    }

    @Override // java.util.concurrent.Callable
    public final List<t6.d> call() {
        Cursor B = v8.b.B(this.f17107b.f17114a, this.f17106a);
        try {
            int U = a1.b.U(B, "id");
            ...
            while (B.moveToNext()) {
                ...
                String string2 = B.isNull(U4) ? null : B.getString(U4);
                int i10 = B.getInt(U5);
                ...
                arrayList.add(new t6.d(j2, j10, string, string2, i10, a10, z10, z11, a11, z12, a12, B.getInt(U12)));
                U = U;
            }
            return arrayList;
        } finally {

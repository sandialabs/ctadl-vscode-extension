...
public final class f implements Callable<t6.a> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ y3.m f17078a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ g f17079b;

    public f(g gVar, y3.m mVar) {
        this.f17079b = gVar;
        this.f17078a = mVar;
    }
    ...
    public final t6.a call() {
        int i10;
        boolean z10;
        Cursor B = v8.b.B(this.f17079b.f17080a, this.f17078a);
        try {
            int U = a1.b.U(B, "id");
            ...
            if (B.moveToFirst()) {
                ...
                SortingOrder U21 = ma.i.U(B.getInt(U14));
                Grouping u12 = m0.b.u1(B.getInt(U15));
                GroupingOrder S = ma.i.S(B.getInt(U16));
                if (B.getInt(U17) != 0) {
                    i10 = U18;
                    z10 = true;
                } else {
                ...
                aVar = new t6.a(j2, valueOf, string2, i11, T, a10, v12, i12, z11, z12, z13, w12, x12, U21, u12, S, z10, ma.i.R(B.getInt(U19)), B.getInt(i10), m0.b.y1(B.getInt(U20)));
            }
            return aVar;
        } finally {
            B.close();

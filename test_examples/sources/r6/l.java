...
public final class l implements Callable<List<t6.c>> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ y3.m f17102a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ j f17103b;

    public l(j jVar, y3.m mVar) {
        this.f17103b = jVar;
        this.f17102a = mVar;
    }
    ...
    public final List<t6.c> call() {
        Cursor B = v8.b.B(this.f17103b.f17091a, this.f17102a);
        try {
            int U = a1.b.U(B, "id");

...
final class FolderDialogFragment$setupListeners$5$1 extends Lambda implements u7.l<Throwable, m7.n> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ FolderDialogFragment f8354j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FolderDialogFragment$setupListeners$5$1(FolderDialogFragment folderDialogFragment) {
        super(1);
        this.f8354j = folderDialogFragment;
    }
    ...
    public final m7.n U(Throwable th) {
        ...
        FolderDialogFragment folderDialogFragment = this.f8354j;
        boolean z10 = ((t6.a) ((kotlinx.coroutines.flow.m) folderDialogFragment.h0().k()).getValue()).f17600j;
        if (z10) {
            i10 = R.string.folder_is_unpinned;
        } else {
            i10 = R.string.folder_is_pinned;
        }
        if (z10) {

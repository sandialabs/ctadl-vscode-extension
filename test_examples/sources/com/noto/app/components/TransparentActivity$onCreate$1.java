...
public final class TransparentActivity$onCreate$1 extends Lambda implements p<a, d, n> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ TransparentActivity f7684j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TransparentActivity$onCreate$1(TransparentActivity transparentActivity) {
        super(2);
        this.f7684j = transparentActivity;
    }
    ...
    public final n R(a aVar, d dVar) {
        ...
        TransparentActivity transparentActivity = this.f7684j;

...
public final class SettingsFragment$onCreateView$1$1 extends Lambda implements l<i, n> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ SettingsFragment f9518j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SettingsFragment$onCreateView$1$1(SettingsFragment settingsFragment) {
        super(1);
        this.f9518j = settingsFragment;
    }

    @Override // u7.l
    public final n U(i iVar) {
        g.f(iVar, "$this$addCallback");
        NavController g10 = ViewUtilsKt.g(this.f9518j);
        if (g10 != null) {
            g10.j();
        }
        return n.f16010a;

...
public final class VaultSettingsFragment extends Fragment {
    ...
    public final e f9767d0 = kotlin.a.a(LazyThreadSafetyMode.SYNCHRONIZED, new VaultSettingsFragment$special$$inlined$viewModel$default$1(this));
    ...
    public final View x(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (j2 != null) {
            ...
            if (c != null && (onBackPressedDispatcher = c.f417p) != null) {
                b.j(onBackPressedDispatcher, null, new VaultSettingsFragment$onCreateView$1$1(this), 3);
            }
            c.f(this);
            ...
            if (g10 != null && (d5 = g10.d()) != null && (a10 = d5.a()) != null) {
                a10.c("click_listener").d(r(), new a(new VaultSettingsFragment$onCreateView$1$2$1(j2, composeView, this)));
            }
            if (new androidx.biometric.l(new l.c(j2)).a() == 0) {
                z10 = true;
            } else {
                z10 = false;
            }
            composeView.setContent(a1.c.j0(2075675462, new VaultSettingsFragment$onCreateView$1$2$2(this, z10), true));
        }
        return composeView;
    }
}

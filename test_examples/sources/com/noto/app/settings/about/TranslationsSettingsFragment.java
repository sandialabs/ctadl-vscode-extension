    ...
    public final View x(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (j2 != null) {
            ...
            if (c != null && (onBackPressedDispatcher = c.f417p) != null) {
                b.j(onBackPressedDispatcher, null, new TranslationsSettingsFragment$onCreateView$1$1(this), 3);
            }
            ComposeView composeView = new ComposeView(j2);
            composeView.setTransitionGroup(true);
            composeView.setContent(a1.c.j0(-843841013, new TranslationsSettingsFragment$onCreateView$1$2$1(this), true));
            return composeView;
        }
        return null;
    }

...
public final class AboutSettingsFragment extends Fragment {
    ...
    public final e f9584d0 = a.b(new AboutSettingsFragment$version$2(this));
    ...
    public final View x(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (j2 != null) {
            ...
            if (c != null && (onBackPressedDispatcher = c.f417p) != null) {
                b.j(onBackPressedDispatcher, null, new AboutSettingsFragment$onCreateView$1$1(this), 3);
            }
            ComposeView composeView = new ComposeView(j2);
            composeView.setTransitionGroup(true);
            composeView.setContent(a1.c.j0(71461953, new AboutSettingsFragment$onCreateView$1$2$1(this), true));
            return composeView;
        }
        return null;
    }

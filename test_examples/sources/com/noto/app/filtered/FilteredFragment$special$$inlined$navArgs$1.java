...
public final class FilteredFragment$special$$inlined$navArgs$1 extends Lambda implements a<Bundle> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ Fragment f8236j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FilteredFragment$special$$inlined$navArgs$1(Fragment fragment) {
        super(0);
        this.f8236j = fragment;
    }

    @Override // u7.a
    public final Bundle k0() {
        Fragment fragment = this.f8236j;

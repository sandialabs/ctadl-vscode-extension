...
public final class SettingsRepositoryImpl$updateQuickNoteFolderId$2 extends SuspendLambda implements p<x, p7.c<? super a>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements p<MutablePreferences, p7.c<? super n>, Object> {
        ...
        /* renamed from: m  reason: collision with root package name */
        public /* synthetic */ Object f8112m;
        ...
        public final Object k(Object obj) {
            ...
            ((MutablePreferences) this.f8112m).d(q6.a.f16938s, new Long(this.n));
            return n.f16010a;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SettingsRepositoryImpl$updateQuickNoteFolderId$2(SettingsRepositoryImpl settingsRepositoryImpl, long j2, p7.c<? super SettingsRepositoryImpl$updateQuickNoteFolderId$2> cVar) {
        super(2, cVar);
    ...
    public final Object R(x xVar, p7.c<? super a> cVar) {
        return ((SettingsRepositoryImpl$updateQuickNoteFolderId$2) a(xVar, cVar)).k(n.f16010a);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final p7.c<n> a(Object obj, p7.c<?> cVar) {
        return new SettingsRepositoryImpl$updateQuickNoteFolderId$2(this.n, this.f8111o, cVar);
    }
    ...
    public final Object k(Object obj) {
        ...
        if (i10 != 0) {
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.f8111o, null);
            this.f8110m = 1;

...
public final class PredefinedEnhancementInfoKt$PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE$1$1$5$2 extends Lambda implements l<d.a.C0157a, n> {
    ...
    public final n U(d.a.C0157a c0157a) {
        ...
        String str = this.f13867j;
        c0157a2.a(str, cVar);
        c0157a2.a(str, cVar);
        c0157a2.b(str, PredefinedEnhancementInfoKt.f13853a);
        return n.f16010a;
    }
}

...
public final class KClassImpl$Data$declaredNonStaticMembers$2 extends Lambda implements u7.a<Collection<? extends KCallableImpl<?>>> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ KClassImpl<T> f13121j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KClassImpl$Data$declaredNonStaticMembers$2(KClassImpl<T> kClassImpl) {
        super(0);
        this.f13121j = kClassImpl;
    }

    @Override // u7.a
    public final Collection<? extends KCallableImpl<?>> k0() {
        KClassImpl<T> kClassImpl = this.f13121j;

...
public final class VectorPainter$vector$1$1 extends Lambda implements a<n> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ VectorPainter f3241j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VectorPainter$vector$1$1(VectorPainter vectorPainter) {
        super(0);
        this.f3241j = vectorPainter;
    }

    @Override // u7.a
    public final n k0() {
        this.f3241j.f3230j.setValue(Boolean.TRUE);
        return n.f16010a;
    }
}

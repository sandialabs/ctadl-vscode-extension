...
public final class NodeLocationHolder$compareTo$child2$1 extends Lambda implements l<LayoutNode, Boolean> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ d f3933j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NodeLocationHolder$compareTo$child2$1(d dVar) {
        super(1);
        this.f3933j = dVar;
    }

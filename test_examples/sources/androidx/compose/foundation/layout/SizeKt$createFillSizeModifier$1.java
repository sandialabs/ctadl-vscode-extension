...
final class SizeKt$createFillSizeModifier$1 extends Lambda implements l<n0, n> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ float f1962j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SizeKt$createFillSizeModifier$1(float f10) {
        super(1);
        this.f1962j = f10;
    }
    ...
    public final n U(n0 n0Var) {
        ...
        n0Var2.f3861a.b(Float.valueOf(this.f1962j), "fraction");
        return n.f16010a;
    }
}

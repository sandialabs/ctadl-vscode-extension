...
public final class ComposerImpl$doCompose$2$4 extends Lambda implements l<g1<?>, n> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ ComposerImpl f2686j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ComposerImpl$doCompose$2$4(ComposerImpl composerImpl) {
        super(1);
        this.f2686j = composerImpl;
    }

    @Override // u7.l
    public final n U(g1<?> g1Var) {
        v7.g.f(g1Var, "it");
        ComposerImpl composerImpl = this.f2686j;
        composerImpl.f2663z--;
        return n.f16010a;
    }
}

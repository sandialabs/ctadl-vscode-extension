...
public final class PersistentVectorBuilder$removeAll$1 extends Lambda implements l<E, Boolean> {

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ Collection<E> f2885j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public PersistentVectorBuilder$removeAll$1(Collection<? extends E> collection) {
        super(1);
        this.f2885j = collection;
    }

    @Override // u7.l
    public final Boolean U(Object obj) {
        return Boolean.valueOf(this.f2885j.contains(obj));
    }
}

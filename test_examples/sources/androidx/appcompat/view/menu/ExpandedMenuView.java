...
public final class ExpandedMenuView extends ListView implements f.b, k, AdapterView.OnItemClickListener {
    ...
    public static final int[] f550j = {16842964, 16843049};
    ...
    public ExpandedMenuView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f550j, 16842868, 0);
    ...
    public final boolean a(h hVar) {
        return this.f551i.q(hVar, null, 0);
    }
